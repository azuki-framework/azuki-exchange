...
/**
 * このクラスは、エクスチェンジ機能を定義するための基底クラスです。
 * 
 * @since 1.0.0
 * @version 1.0.0 2014/07/14
 * @author Kawakicchi
 */
public abstract class AbstractExchange<INPUT extends InputPart, OUTPUT extends OutputPart> implements Exchange<INPUT, OUTPUT> {
